                                            ...
                                            <div class="widget-content p-0">
                                                <div class="widget-content-wrapper">
                                                    ...
                                                    <div class="widget-content-left">
                                                        ...
                                                        <div class="widget-subheading opacity-8">(Agent)
                                                        </div>
                                                    </div>
...
<!-- <div class="app-header header-shadow" style="top: 61px; padding: 0px!important; margin: 0px; height: 30px;z-index: 9;background: #f3f3f3;">
<div class="app-header__content">
<marquee><img src="{{asset('images/spekar.png')}}" width="40px;" style="animation: blink .5s step-end infinite alternate; transition: color .15s,background-color .15s,border-color .15s,box-shadow .15s;" >&nbsp;<strong style="background: yellow; color: red; border-radius: 20%; padding: 3px; margin-right: 5px;"> Notice :- </strong> <span style="background: yellow;
    padding: 5px;
    color: red;
    font-weight: 800;">{{$announcements['name']}}</span> </marquee>
</div>
</div>
 -->
