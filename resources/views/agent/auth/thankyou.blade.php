                                ...
                                <div class="jumbotron ">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12 col-md-10 offset-md-1">
                                        ...
                                        <h1 class=" text-center">THANKS FOR REGISTERING WITH<br> ADMIT OFFER</h1>
                                      <h5 class="lead text-center"><strong>“Please download your agreement, print, sign and stamp (your company stamp) the agreement and email it to <span class="text-warning">contact@admitoffer.com</span>”. </h5>
                                        <h6>Thank you</h6>
                                      <hr>
                                      <p class="text-center ">
                                      ...
                                      <p class="lead text-center">
                                        <a class="btn btn-primary btn-sm" href="{{route('agent.createPdf',base64_encode($id))}}" target="_blank" role="button">Download Agreement</a>
                                      </p>
