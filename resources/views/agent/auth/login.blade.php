  ...
  <div class="row" >
   ...
   <div class="col-12 col-md-12 col-lg-6 part1">
     <div class="login_form">
      ...
      @endif
      <form class="form-signin" method="POST" action="{{ route('agent.login') }}" aria-label="{{ __('Login') }}">
            @csrf
      ...
      <button class="btn btn-lg  btn-block btn2" type="submit">Sign in</button>
        ...
        <div class="small_txt"><p>Don't have acount? <strong><a href="{{ route('agent.registers') }}">Signup Now</a></strong></p></div><br>
        <div class=""><p><strong><a href="{{ route('agent.password.request') }}">Forgot Password</a></strong></p></div>
