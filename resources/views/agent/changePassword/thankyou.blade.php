                                ...
                                <div class="jumbotron ">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12 col-md-10 offset-md-1">
                                      ...
                                      <h5 class="lead text-center"><strong>“We will evaluate your documents and our team will get back to you soon, In the mean while please find below your contract, print it, sign it, stamp it (company stamp) and email it to <span class="text-warning">info@admitoffer.com</span>.” </h5>
                                      <hr>
                                      <p class="text-center">
                                        Having trouble? <a href="{{route('contactus')}}">Contact us</a>
                                      </p>
                                      <h3 class="text-center">
                                        Admit Offer Contract <a href="{{route('agent.createPdf',base64_encode($id))}}" target="_blank">Download Contract</a>
                                    </h3>
                                      <p class="lead text-center">
                                        <a class="btn btn-primary btn-sm" href="{{route('agent.login')}}" role="button">Back to login</a>
                                      </p>
